...
%     [delta_noise, kappa_x_i, kappa_y_i] = generate_representations;
%this function simulates kappas and xi-yi
        %
        % ======= OUTPUT VARIABLE =====
    ...
    switch model
        case 'bayes'
            ...
            p_C_hat = p_C_hat > k; %1;      % respond 1 if log(d) > log(1)
        case 'freq'
...
%                      HELPER FUNCTIONS
% % ================================================================
%     function [delta_noise, kappa_x, kappa_y] = generate_representations
%         %this function simulates kappas and xi-yi
%         %
%         % ======= OUTPUT VARIABLE =====
%         % DELTA_NOISE: matrix of dimension [nTrials,nItems,nSamples]
